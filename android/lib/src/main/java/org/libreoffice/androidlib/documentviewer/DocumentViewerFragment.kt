...
import org.libreoffice.androidlib.AsyncProcessStatusFragment
import org.libreoffice.androidlib.ViewModelFactory
import org.libreoffice.androidlib.data.AsyncProcessStatus
import org.libreoffice.androidlib.extensions.observe
import org.libreoffice.androidlib.extensions.viewBinding
 ...
 */
internal class DocumentViewerFragment : Fragment(R.layout.fragment_document_viewer) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            viewModel.prepareAndLoadFile(fileToLoad)
        }
    }
